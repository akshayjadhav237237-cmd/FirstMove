      ...
      <div className="flex-1 min-h-0">
        <PanelGroup direction="horizontal" className="h-full">
          ...
          <Panel defaultSize={45} minSize={30} className="flex flex-col h-full">
            {/* Panel header */}
            <div className="h-10 flex-shrink-0 flex items-center justify-between px-4 bg-white/[0.01] border-b border-white/[0.06] border-r border-r-white/[0.06]">
              <span className="text-[10px] font-mono text-[#f7f8f8] font-semibold uppercase tracking-widest">
                SYSTEM_BLUEPRINTS
              </span>
              <div className="flex items-center gap-3">
                <span className="text-[9px] font-mono text-[#62666d]">NODE_MAP: v3</span>
                <button
                  onClick={() => dispatch({ type: "RESET" })}
            ...
            <div className="flex-1 overflow-y-auto p-5 bg-canvas">
              ...
              <div
                className="bg-surface border border-white/[0.06] rounded-lg p-4 mb-6"
          ...
          <PanelResizeHandle className="relative w-1 bg-canvas hover:bg-white/[0.04] transition-colors duration-150 cursor-col-resize group">
            <div className="absolute top-0 bottom-0 left-0 w-px bg-white/[0.06] group-hover:bg-white/[0.14] group-active:bg-accent/60 transition-all duration-150" />
          </PanelResizeHandle>
          ...
          <Panel defaultSize={55} minSize={35} className="flex flex-col h-full">
            ...
            {/* Scrollable content */}
            <div className="flex-1 overflow-y-auto p-5 bg-panel-r">
