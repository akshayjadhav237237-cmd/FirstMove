  ...
  return (
    <div className="bg-[#0D1220] border border-white/[0.07] rounded-[20px] p-6 relative overflow-hidden flex flex-col h-full min-h-0 select-none">
      ...
      <div className="pt-3 flex flex-col flex-1 min-h-0">
        ...
        {/* Verdict text */}
        <div className="text-[13px] text-[#94A3B8] leading-[1.7] flex-1 mb-3 pr-1">
...
export default function Screen3_Workspace() {
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-[#080C14] overflow-hidden font-sans">
      ...
      <main className="w-full h-[calc(100vh-48px)] overflow-y-auto bg-[#080C14]">
        <div className="max-w-7xl mx-auto p-6 flex flex-col gap-6">

          {/* ━━━ SECTION 1: PROBLEM STATEMENT + FIRSTMOVE ━━━ */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            
            {/* Problem Statement Card */}
            <div className="lg:col-span-2 bg-[#0D1220] border border-white/[0.07] rounded-[20px] p-8 flex flex-col select-none">
            ...
            <div 
              className="lg:col-span-1 border rounded-[20px] p-[28px] flex flex-col justify-between"
              style={{
          ...
          {/* ━━━ SECTION 3: ASSUMPTIONS + ROADMAP + SCENARIOS ━━━ */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            
            {/* Assumptions Card */}
            <div className="bg-[#0D1220] border border-white/[0.07] rounded-[20px] p-[20px_22px] min-h-[320px] flex flex-col overflow-hidden">
            ...
            <div className="bg-[#0D1220] border border-white/[0.07] rounded-[20px] p-[20px_22px] min-h-[320px] flex flex-col overflow-hidden">
              ...
              <div className="flex-1 pr-1 relative pl-8 select-none">
                {/* Vertical Line */}
            ...
            <div className="bg-[#0D1220] border border-white/[0.07] rounded-[20px] p-[20px_22px] min-h-[320px] flex flex-col overflow-hidden">
              ...
              <div className="flex-1 pr-1 space-y-[18px]">
